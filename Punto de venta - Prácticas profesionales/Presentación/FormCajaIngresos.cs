...
{
    public partial class FormCajaIngresos : Form
    {
        public double MontoIngresado { get; private set; }
        public FormCajaIngresos()
        {
            InitializeComponent();
        }
        ...
        {
            {
                ...
                {
                    MontoIngresado = monto; // Guardamos el monto ingresado
